...
| `tagged_text_translation` | `public` | `root` |
...
| `ASSET_IMAGE_TAGGING_MAX_ITEMS` | `asset_image_tagging` 的单 Job item 数量上限；默认外部最多 10 个 item，内部通过 workflow 拆成单 item child job |
