...
本目录定义小说本地化 AI 能力层对业务后端提供的 API 接口。

## 文件清单

| 文档 | 用途 | 受众 |
|---|---|---|
| **小说本地化AI能力层接口文档v3.md** | API 详细规范，包含五大接口、请求/响应格式、错误码、限制规则 | 架构师、后端开发者 |
| **小说本地化AI能力层_后端对接接口文档.md** | 后端对接版本，删除冗余，重点突出关键字段和调用流程，含代码示例 | 后端开发者 |
