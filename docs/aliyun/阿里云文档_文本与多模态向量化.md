...
-   **处理大规模数据**：若您需要处理大规模、非实时的文本数据，建议使用 `qwen3.7-text-embedding` 或 `text-embedding-v4` 并结合 [OpenAI兼容-Batch调用](/zh/model-studio/batch-interfaces-compatible-with-openai)，以显著降低成本。
