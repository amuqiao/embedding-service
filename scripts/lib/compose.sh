...
compose() {
  ...
  for key in API_HOST_PORT POSTGRES_DB POSTGRES_HOST_PORT REDIS_HOST_PORT WORKER_PROCESSES WORKER_MAX_ASYNC_TASKS WORKER_MAX_PREFETCH WORKER_LOGLEVEL; do
