...
from app.capabilities.media.audio_input import AUDIO_INPUT_CONTENT_TYPES, AUDIO_WAV_CONTENT_TYPE, PreparedAudioInput
...
class AudioStemSeparationStorageAdapter(BaseObjectStorageAdapter):
    ...
    @classmethod
    def from_settings(cls, settings: Any = app_settings) -> AudioStemSeparationStorageAdapter:
    ...
    ) -> AudioStemSeparationStorageAdapter:
        return cls(
