...
class AudioStemSeparationTritonStoragePolicy:
    output_namespace: str = "audio-stem-separation-triton"
...
def allowed_input_buckets(policy: AudioStemSeparationTritonStoragePolicy, settings: Any) -> tuple[str, ...]:
...
def allowed_input_regions(policy: AudioStemSeparationTritonStoragePolicy, settings: Any) -> tuple[str, ...]:
...
def input_max_bytes(policy: AudioStemSeparationTritonStoragePolicy, settings: Any) -> int:
