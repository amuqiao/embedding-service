...
@router.post("/jobs", response_model=ResponseEnvelope[JobResponseData], status_code=status.HTTP_202_ACCEPTED)
...
@router.get("/jobs/{job_id}", response_model=ResponseEnvelope[JobResponseData])
