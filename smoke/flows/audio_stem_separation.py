...
from smoke.flows import llm_job_billing, oss_image_upload, poster_title_image
...
def _stage_local_audio(
    *,
    ...
    bucket = llm_job_billing.env_value("OSS_BUCKET", app_env) or "local-dev"
    region = llm_job_billing.env_value("OSS_REGION", app_env) or "local"
